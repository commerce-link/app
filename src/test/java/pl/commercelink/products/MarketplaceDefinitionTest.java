...
class MarketplaceDefinitionTest {
    ...
    void isCompleteWhenOnlyDistributorsCriteriaAreSet() {
        // given
        MarketplaceDefinition definition = new MarketplaceDefinition("Morele", 1.1, 5, 2, 0);
    ...
    void isCompleteWhenOnlyWarehouseCriteriaAreSet() {
        // given
        MarketplaceDefinition definition = new MarketplaceDefinition("Morele", 1.1, 0, 0, 3);
    ...
    void isNotCompleteWhenDistributorsCriteriaArePartiallySet() {
        // given
        MarketplaceDefinition definition = new MarketplaceDefinition("Morele", 1.1, 5, 0, 0);
    ...
    void isNotCompleteWithoutNameOrMarkup() {
        // when / then
        assertThat(new MarketplaceDefinition(null, 1.1, 5, 2, 3).isComplete()).isFalse();
        assertThat(new MarketplaceDefinition("Morele", 0, 5, 2, 3).isComplete()).isFalse();
    }
}
