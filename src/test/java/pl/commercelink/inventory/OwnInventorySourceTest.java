...
class OwnInventorySourceTest {
    ...
    void appendsItemsFromOwnGroupsMatchingLookupKey() {
        ...
        OwnInventorySource source = new OwnInventorySource(List.of(own));
    ...
    void selectsMfnMatchOverEanOnlyMatch() {
        ...
        OwnInventorySource source = new OwnInventorySource(List.of(eanMatch, mfnMatch));
    ...
    void selectsLargestOwnGroupAmongMfnMatches() {
        ...
        OwnInventorySource source = new OwnInventorySource(List.of(small, big));
        InventoryKey lookupKey = InventoryKey.fromMfn("M1");
        MatchedInventory result = accumulator(lookupKey);
    ...
    void ignoresOwnGroupsThatDoNotMatch() {
        ...
        OwnInventorySource source = new OwnInventorySource(List.of(unrelated));
        InventoryKey lookupKey = InventoryKey.fromMfn("M1");
        MatchedInventory result = accumulator(lookupKey);
    ...
    void mergesNothingWhenOwnInventoryEmpty() {
        // given
        OwnInventorySource source = new OwnInventorySource(List.of());
        InventoryKey lookupKey = InventoryKey.fromMfn("M1");
        MatchedInventory result = accumulator(lookupKey);
