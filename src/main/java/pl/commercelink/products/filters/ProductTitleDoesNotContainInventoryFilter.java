...
public class ProductTitleDoesNotContainInventoryFilter extends InventoryFilter {
    ...
    static {
        FIELDS_LIST.add(new MetadataField(KEYWORDS_FIELD_NAME, "Comma separated list of keywords. Considered true if none of the keywords is found in the product title."));
    }

    public ProductTitleDoesNotContainInventoryFilter() {
        super(InventoryFilterType.PRODUCT_TITLE_DOES_NOT_CONTAIN, FIELDS_LIST);
    }
