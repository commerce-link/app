...
@ChangeUnit(id = "V017-seed-taxonomy-from-daily-file", order = "017", author = "commercelink")
@Slf4j
public class V017_SeedTaxonomyFromDailyFile {
    ...
    public V017_SeedTaxonomyFromDailyFile(TaxonomyRepository taxonomyRepository,
